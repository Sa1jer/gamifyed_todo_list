  ...
  static const _sections = <_FAQSection>[
    _FAQSection(
      ...
      bullets: [
        ...
        'XP и уровни показывают реальный накопленный прогресс.',
      ],
    ),
    _FAQSection(
    ...
    _FAQSection(
      ...
      bullets: [
        'Узел — этап навыка: основы, практика, проект или отдельная техника.',
        'Квесты можно связать с узлом, чтобы видеть, что именно двигает этап.',
        'Освоение узла даёт XP и помогает прогрессу против боссов.',
      ],
    ),
    _FAQSection(
