...
class FAQDialog extends StatelessWidget {
  ...
  static const _sections = <_FAQSection>[
    ...
    _FAQSection(
      ...
      bullets: [
        ...
        'Мини-статистика показывает XP, выполненные задачи и daily-квесты.',
    ...
    _FAQSection(
      ...
      bullets: [
        ...
        'У повторяющихся задач лёгкий старт может закрыть daily-квест дня.',
      ],
    ),
    _FAQSection(
      icon: Icons.bolt,
    ...
    _FAQSection(
      ...
      bullets: [
        'Сундуки выдаются за дневной темп, стрики и победы над боссами.',
  ...
  static const _quickStart = <String>[
    ...
    'Создай маленькие квесты и хотя бы один repeating-квест.',
