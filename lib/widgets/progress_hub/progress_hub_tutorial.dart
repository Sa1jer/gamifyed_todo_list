...
class ProgressTutorialSpotlight extends StatefulWidget {
  final GlobalKey targetKey;
  final bool isDark;
  final VoidCallback onComplete;

  const ProgressTutorialSpotlight({
    super.key,
  ...
  @override
  State<ProgressTutorialSpotlight> createState() =>
      _ProgressTutorialSpotlightState();
}

class _ProgressTutorialSpotlightState extends State<ProgressTutorialSpotlight> {
  Rect? _targetRect;
