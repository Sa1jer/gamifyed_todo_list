...
///
/// Мягкая и почти чёрная: на тёмной подложке её не видно вовсе, а на светлой
/// она даёт кромку, за которую цепляется глаз. Смещение на пиксель вниз —
/// чтобы это читалось как тень, а не как обводка или ореол.
